        ...
        <div id="show-blog" class="content scaffold-show" role="main">
            ...
            <g:form resource="${this.blog}" method="DELETE">
                <fieldset class="buttons">
                    ...
                    <input class="delete" type="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
                </fieldset>
            </g:form>
        </div>
    </body>
